...
export const Position = (
    ...
    return (
        <div className={`${leaderboardPosition.position > 4 ? 'mt-[4px]' : ''} flex justify-between items-center`}>
...
const SkeletonBox = ({ width = '100%', height = '20px', className = '' }) => (
    <div
        className={`animate-pulse [animation-duration:1.2s] bg-gray-200 rounded-md ${className}`}
        style={{ width, height }}
    />
);
...
export const PositionSkeleton = (
    ...
    return (
        <div className={`${position > 4 ? 'mt-[4px]' : ''} flex justify-between items-center`}>
            <div className="flex items-center justify-center ">
                <div className={`flex items-center justify-center ${position > 10 ? 'bg-blue-500' : 'bg-green-500'} w-[33px] h-[33px] rounded-md border-[1px] border-[#030303] shadow-[0px_2px_0px_rgba(0,0,0,0.45)] text-[14px]`}>{position}</div>
                <SkeletonBox className="ml-[8px]" width="60px" />
            </div>
            <SkeletonBox className="ml-[8px]" width="100px" />
        </div>
    )
}
...
const SkeletonLeaderboard = () => {
    return (
        <>
            <div className="flex justify-between">
                <div className="flex h-[153px] flex-col items-center justify-center px-[10px] pt-[6px] pb-[8px] rounded-md border-[2px] border-[#030303] shadow-[0px_2px_0px_rgba(0,0,0,0.45)] bg-gradient-to-b from-[#FEED88] to-[#FFAB2B]">
                    {/* <div className="text-[16px]">{leaderboard[0] ? displayAddress(leaderboard[0].wallet) : 'none'}</div> */}
                    <SkeletonBox />
                    <img className="mt-[8px]" width={74} height={74} src="/1stplace.png" alt="1stplaceimg" />
                    <SkeletonBox className="mt-[8px]" />
                </div>

                <div className="flex h-[153px] flex-col items-center justify-center px-[10px] pt-[6px] pb-[8px] rounded-md border-[2px] border-[#030303] shadow-[0px_2px_0px_rgba(0,0,0,0.45)] bg-gradient-to-b from-[#FDF4FB] to-[#A8B5BD]">
                    <SkeletonBox />
                    <img className="mt-[8px]" width={74} height={74} src="/2ndplace.png" alt="1stplaceimg" />
                    <SkeletonBox className="mt-[8px]" />
                </div>

                <div className="flex h-[153px] flex-col items-center justify-center px-[10px] pt-[6px] pb-[8px] rounded-md border-[2px] border-[#030303] shadow-[0px_2px_0px_rgba(0,0,0,0.45)] bg-gradient-to-b from-[#FFC790] to-[#CB6326]">
                    <SkeletonBox />
                    <img className="mt-[8px]" width={74} height={74} src="/3rdplace.png" alt="1stplaceimg" />
                    <SkeletonBox className="mt-[8px]" />
                </div>
            ...
            <div className="mt-10 relative w-full">
                ...
                >
                    {[
                        ...
                        <PositionSkeleton key={index} position={leaderboardPosition.position} />
                    ))}
                </div>
            </div>
        </>
