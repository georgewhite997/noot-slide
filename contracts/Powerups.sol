...
contract Powerups is Ownable {
    ...
    function getOwnedPowerups(
        address _user,
        uint16[] calldata ids
    ) public view returns (uint256[] memory quantities) {
